...
if(get_option('dan_marquee_button_v2_enable') == 'true'){
  \Breakdance\ElementStudio\registerElementForEditing(
    "Dancepad\\MarqueeButtonV2",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class MarqueeButtonV2 extends \Breakdance\Elements\Element
{
    ...
    {
        return 'Marquee Button v2';
    }

    static function className()
    {
        return 'dan-marquee-button-v2';
    }
    ...
    static function contentControls()
    {
        ...
        "Split type",
        [],
        ['type' => 'dropdown', 'layout' => 'inline', 'items' => [['value' => 'lines', 'text' => 'lines'], ['text' => 'words', 'value' => 'words'], ['text' => 'chars', 'value' => 'chars']]],
        false,
        false,
        [],
      ), c(
    ...
    static function dependencies()
    {
        return [
            '0' =>  [
                'title' => 'Dancepad - Marquee Button v2',
                'scripts' => [DANCEPAD_PLUGIN_URL . 'elements/Marquee_Button_v2/dancepad_marquee_button_v2.min.js?ver=' . DANCEPAD_VERSION],
            ],
            '1' =>  [
                'title' => 'Init Builder',
                'inlineScripts' => ['dancepad_marquee_button_v2();'],
...
'onPropertyChange' => [['script' => 'dancepad_marquee_button_v2();',
],],

'onCreatedElement' => [['script' => 'dancepad_marquee_button_v2();',
],],

'onMountedElement' => [['script' => 'dancepad_marquee_button_v2();',
],],

'onMovedElement' => [['script' => 'dancepad_marquee_button_v2();',
],],

'onAfterDeletedElement' => [['script' => 'dancepad_marquee_button_v2();',
],],];
    }
    ...
    {
        return [
            ['name' => 'data-type', 'template' => '{{ content.animation.split_type }}'], 
    ...
    {
        return [['accepts' => 'string', 'path' => 'content.animation.distance'], ['accepts' => 'string', 'path' => 'content.content.marquee_text'], ['accepts' => 'string', 'path' => 'content.content.swap_text']];
    }
