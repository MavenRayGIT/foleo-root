...
if(get_option('dan_scroll_reading_enable') == 'true'){
  \Breakdance\ElementStudio\registerElementForEditing(
    "Dancepad\\ScrollReading",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class ScrollReading extends \Breakdance\Elements\Element
{
    ...
    {
        return ['content' => ['content' => ['text' => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis nec leo et mi mollis dictum. Vivamus bibendum est vel elit eleifend sodales. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis nec leo et mi mollis dictum. Vivamus bibendum est vel elit eleifend sodales. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis nec leo et mi mollis dictum. Vivamus bibendum est vel elit eleifend sodales. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis nec leo et mi mollis dictum. Vivamus bibendum est vel elit eleifend sodales.', 'tag' => 'span', 'link' => null], 'animation' => ['duration' => ['number' => 1, 'unit' => 's', 'style' => '1s'], 'distance' => ['number' => 100, 'unit' => '%', 'style' => '100%'], 'split_type' => 'lines', 'from' => 'bottom', 'distance_dynamic_meta' => null, 'skew' => 0, 'stagger' => 0.05, 'delay' => ['number' => 0, 'unit' => 's', 'style' => '0s'], 'gsap_easing' => 'power3'], 'scrolltrigger' => ['additional_triggers' => null, 'trigger' => 'this', 'start' => 'top center', 'end' => 'bottom center', 'toggleactions' => 'play none none none', 'scroller' => 'body'], 'mask' => ['mask_color' => '#FFFFFFFF', 'text_opacity' => 0.1, 'mask_zindex' => '9999']], 'design' => ['typography' => ['text' => ['custom' => ['customTypography' => ['fontFamily' => null, 'fontSize' => ['number' => 75, 'unit' => 'px', 'style' => '75px'], 'advanced' => ['letterSpacing' => null]]]], 'color' => null, 'color_hover' => null, 'typography' => ['custom' => ['customTypography' => ['fontFamily' => null, 'fontSize' => ['breakpoint_base' => ['number' => 64, 'unit' => 'px', 'style' => '64px']], 'fontFamily_hover' => null, 'fontSize_hover' => null]]]], 'elements_hive' => ['backlight' => ['enabled' => false]], 'style' => ['new_control' => ['label' => 'Preset 0', 'id' => 'preset-id-72d05461-b30c-4ca4-be1a-3a678f1d3fcf'], 'typography' => ['custom' => ['customTypography' => ['fontSize' => null, 'fontFamily' => null]]]]]];
    }
    ...
    static function dependencies()
    {
        return [
            '0' =>  [
                'title' => 'Dancepad - Scroll Reading',
                'scripts' => [DANCEPAD_PLUGIN_URL . 'elements/Scroll_Reading/dancepad_scroll_reading.min.js?ver=' . DANCEPAD_VERSION],
            ],
            '1' =>  [
                'title' => 'Init Builder',
                'inlineScripts' => [
                    'dancepad_scroll_reading();'
                ],
...
'onPropertyChange' => [['script' => 'dancepad_scroll_reading();',
],],

'onCreatedElement' => [['script' => 'dancepad_scroll_reading();',
],],

'onMountedElement' => [['script' => 'dancepad_scroll_reading();',
],],

'onMovedElement' => [['script' => 'dancepad_scroll_reading();',
],],

'onAfterDeletedElement' => [['script' => 'dancepad_scroll_reading();',
],],];
    }
    ...
    {
        return [['accepts' => 'string', 'path' => 'content.content.text'], ['accepts' => 'string', 'path' => 'content.animation.distance'], ['accepts' => 'string', 'path' => 'content.mask.text_opacity']];
    }
