...
if(get_option('dan_marquee_button_enable') == 'true'){
    \Breakdance\ElementStudio\registerElementForEditing(
        "Dancepad\\MarqueeButton",
        \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
    );
    
    class MarqueeButton extends \Breakdance\Elements\Element
    {
